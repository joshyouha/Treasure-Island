...
if choice1 == "left":
   ...
   if choice2 == "swim":
        ...
        if choice3 == "red":
            print("It's a room full of fire.You are burned by fire. Game Over.")
        elif choice3 == "yellow":
            print("You found the treasure. You win!")
        elif choice3 == "blue":
            print("You entered a room of beasts and eaten by beasts. Game Over.")
        else:
